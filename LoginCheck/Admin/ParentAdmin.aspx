<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ParentAdmin.aspx.cs" Inherits="LocationRepresentation.Admin.ParentAdmin" %>
        ...
        <tr>
            <td class="auto-style1">
                <table>
                        <tr>
        <td>
<asp:Button ID="Button1" runat="server" CssClass="btn active" Text="Add Sub Company" Width="184px" OnClick="btnSubCompany_Click1" />
        </td>
        <td>
            &nbsp;</td>
        <td>
            <asp:Button ID="Button2" runat="server" Text="Clear Filters" CssClass="btn active" Width="190px" OnClick="btnClearFilter_Click" />
        </td>
        <td>
            &nbsp;</td>
        <td>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ID:</td>
                        <td>
                            <asp:TextBox ID="txtID" runat="server" MaxLength="20" CssClass="form-control" Width="150px"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td class="auto-style2">
        ...
        <tr>
            <td class="auto-style1">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No Orders found" ForeColor="#333333" GridLines="None" Width="100%"  DataKeyNames="ID" DataSourceID="SqlDataSource1">
        ...
        <tr>
            <td class="auto-style1">
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:webafricaConnectionString %>" SelectCommand="SELECT [Company], [Branch], [UserStructure], [ParentCompany] FROM [SubCompany]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
